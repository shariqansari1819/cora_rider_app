...
class DispatchRequest extends StatefulWidget {
  const DispatchRequest({Key? key}) : super(key: key);

  @override
  _DispatchRequest createState() => _DispatchRequest();
}

class _DispatchRequest extends State<DispatchRequest> {
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Align(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.only(
                                      top: 10.0,left:5.0,bottom: 10.0,right: 10.0),
                                  child: Container(
                                    height: 60.0,
                                    width: 255.0,
                                    child: PrimaryButton(
